...
const Avatar = ({ name, size=44 }) => {
  ...
  return (
    <div style={{ width:size, height:size, borderRadius:"50%", background:C.orange, color:"#fff", display:"flex", alignItems:"center", justifyContent: "flex-start", fontSize:size*0.36, fontWeight:800, flexShrink:0 }}>
      {init}
    </div>
  );
};
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
          {[
            ...
            <div key={a.label} onClick={()=>a.action&&onNav(a.action)} style={{ background:C.card, borderRadius:14, padding:"16px 14px", cursor:"pointer", boxShadow:"0 1px 4px rgba(0,0,0,0.06)", display:"flex", flexDirection:"column", gap:6 }}>
              <div style={{ width:38, height:38, borderRadius:10, background:a.color+"18", display:"flex", alignItems:"center", justifyContent: "flex-start", fontSize:18 }}>{a.icon}</div>
    ...
    return (
      <div style={{ flex:1, display:"flex", flexDirection:"column" }}>
        <div style={{ background:C.green, padding:"44px 20px 24px", display:"flex", alignItems:"center", gap:14 }}>
          <button onClick={()=>setSelected(null)} style={{ background:"rgba(255,255,255,0.15)", border:"none", borderRadius:8, width:34, height:34, color:"#fff", fontSize:18, cursor:"pointer", display:"flex", alignItems:"center", justifyContent: "flex-start" }}>‹</button>
          <div>
      ...
      <div style={{ flex:1, overflowY:"auto", padding:"14px 16px", paddingBottom:90 }}>
        {TRIPS.map(t=>(
          <div key={t.id} onClick={()=>setSelected(t.id)} style={{ background:C.card, borderRadius:14, padding:"16px", marginBottom:10, boxShadow:"0 1px 4px rgba(0,0,0,0.05)", cursor:"pointer", display:"flex", alignItems:"center", gap:14 }}>
            <div style={{ width:44, height:44, borderRadius:12, background:C.light, display:"flex", alignItems:"center", justifyContent: "flex-start", fontSize:20, flexShrink:0 }}>🚛</div>
            <div style={{ flex:1 }}>
      ...
      <div style={{ flex:1, overflowY:"auto", padding:16, paddingBottom:90 }}>
        ...
        {EXPENSES.map(e=>(
          <div key={e.id} style={{ background:C.card, borderRadius:14, padding:"14px 16px", marginBottom:8, display:"flex", alignItems:"center", gap:12, boxShadow:"0 1px 4px rgba(0,0,0,0.05)" }}>
            <div style={{ width:40, height:40, borderRadius:10, background:C.light, display:"flex", alignItems:"center", justifyContent: "flex-start", fontSize:20, flexShrink:0 }}>{e.icon}</div>
            <div style={{ flex:1 }}>
  ...
  return (
    <div style={{ flex:1, overflowY:"auto", paddingBottom:90 }}>
      ...
      <div style={{ background:C.green, padding:"44px 20px 32px", textAlign:"center" }}>
        ...
        <div style={{ display:"flex", justifyContent: "flex-start", gap:20, marginTop:16 }}>
      ...
      <div style={{ padding:"16px" }}>
        ...
        <div style={{ background:C.card, borderRadius:14, padding:18, boxShadow:"0 1px 4px rgba(0,0,0,0.05)" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:14 }}>
            <div style={{ width:52, height:52, borderRadius:14, background:C.light, display:"flex", alignItems:"center", justifyContent: "flex-start", fontSize:26 }}>🚛</div>
            <div>
...
export default function DriverApp() {
  ...
  return (
    <div style={{ display:"flex", alignItems:"center", justifyContent: "flex-start", minHeight:"100vh", background:"#d8d5cc", fontFamily:"'DM Sans','Segoe UI',sans-serif" }}>
      {/* Phone frame */}
      <div style={{ width: 100%, height: 100%, background:C.cream, borderRadius:44, overflow:"hidden", display:"flex", flexDirection:"column", position:"relative", boxShadow:"0 32px 80px rgba(0,0,0,0.35), 0 0 0 8px #b0ada4, 0 0 0 10px #c0bdb4" }}>
